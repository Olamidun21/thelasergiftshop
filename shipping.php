...
<section class="about-page section-big-py-space">
    <div class="custom-container">
        <div class="row">
            <div class="col-lg-10">
                <h4>UK- FREE 1st class postage for orders of £9.99 and above</h4>
                <p class="mb-2">No tracking available with this standard posting</p>
                <p class="mb-2">Delivery usually within 2-5 working  days from postage </p>
                <h4>UK- Standard 1st class postage for orders of £9.98 and below- £1.00</h4>
                <p class="mb-2">No tracking available with this standard posting</p>
                <p class="mb-2">Delivery usually within 2-3 days from postage</p>
                <h4>UK- 1st Class Tracked & Signed- £3.99</h4>
                <p class="mb-2"></p>
                <p class="mb-2">Delivery usually within 2-3 days from postage</p>
                <h4>UK- Next Day guarantee- £8.99</h4>
                <p class="mb-2"></p>
                <p class="mb-2">Delivery usually within 1 day from postage</p>
                <h4>UK- Saturday guarantee delivery - £12.99</h4>
                <p class="mb-2">Order must have been received before the close of day on Thursday</p>
                <p class="mb-2"></p>
                <h4>All of Europe</h4>
                <p class="mb-2">Flat rate per order- £12.99</p>
                <p class="mb-2"> </p>
                <h4>USA & Canada</h4>
                <p class="mb-2">Flat rate per order- £16.99</p>
                <h4>Rest of the world:</h4>
                <p class="mb-2">Please contact us for a quote providing your location address and your purchase of choice</p>
                <br>
                <small color="black"><h6>We advise that you upgrade your delivery method to "Tracked and signed" if you would like to be able to track the delivery journey of your order. <b style="color:black;">If standard 1st class is chosen, tracking information will not available.</b><br>
**All items are usually posted within 2-3 days. For example, Orders placed on Monday, would be dispatched on Wednesday- so a next-day guarantee order would usually arrive the day after the order is posted- i.e. Wednesday if ordered on Monday.<h6></small>
            </div>
        </div>
    </div>
</section>
...
<!--services start-->
<!--<section class="services section-big-mb-space">-->
<!--    <div class="container">-->
