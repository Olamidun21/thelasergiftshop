...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="s tylesheet">
	...
	<path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                        ...
                        <div class="single-item">
                            <div>
                                <div>
                                    <h3>Welcome to The Laser Gift Shop</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form id="login" class="form-horizontal auth-form">
                                        <div class="form-group">
                                            <input required="" name="login[username]" type="email" class="form-control" placeholder="Email" id="email">
                                        </div>
                                        <div class="form-group">
                                            <input required="" name="login[password]" type="password" class="form-control" placeholder="Password" id="password">
                                        </div>
    ...
    // );
			...
			// $('#form').submit(function(e){
				...
				$.post('admin.php',{ email, password, request: 'login' }, function(res){
					...
					res = JSON.parse(res);
					if(res.success){
					// resp = swal('Congratulations!', 'Your message has been succesfully sent', 'success');
					// if(sweetAlert.close()) 
