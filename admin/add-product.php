                            ...
                            <div class="card-body">
                                <div class="digital-add needs-validation">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="slug" type="text" required="" name="slug">
                                    </div>
                                    <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="custom-select" required="" name="subcategory" id="subcate">
                                                                   
                                                                </select>
                                                            </div>
                                    <div class="form-group">
                                        <label class="col-form-label">Short Description</label>
                                        <textarea rows="5" cols="12" name="short_description" id="short_description"></textarea>
                                    </div>
                                    <div class="form-group">
