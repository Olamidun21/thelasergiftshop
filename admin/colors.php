                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="btn-popup pull-right">
                                    <button type="button" class="btn btn-secondary" data-toggle="modal" data-original-title="test" data-target="#exampleModal">Add Color</button>
                                                    ...
                                                    <form id="cat" class="needs-validation" enctype="multipart/form-data">
                                                        <div class="form">
                                                            ...
                                                            <div class="form-group mb-0">
                                                                <label for="validationCustom02" class="mb-1">Color Image :</label>
                                                                <input class="form-control" name="image" id="image" type="file">
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-0">
                                                                <label for="validationCustom02" class="mb-1">Color Hex code :</label>
                                                                <input class="form-control" name="hex" id="hex" type="text">
                                                            </div>
                                                        </div>
                                                        <input type="hidden" value="addcolor" name="request">
<!-- </br>
