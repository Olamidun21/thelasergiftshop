...
if(!isset($_SESSION)){
  ...
  $color = $obj->getcolors($product_id);
//   $font = $obj->getfont($product_id); 
//   $shape = $obj->getshapes($product_id);
//   $material = $obj->getmaterial($product_id);
//   $holes = $obj->getholes($product_id);
  $size = $obj->getsizes($product_id);
                        ...
                        <div class="card">
                            ...
                            ?>
                                        ...
                                        <?php } ?>
                                            ...
                                            <div class="form-group">
                                                 <label for="select" class=" form-control-label">Sizes</label>
                                                    <select name="psizes[]"  class="form-control chosen-select">
                                        ...
                                        <?php } ?>
                                            ...
                                            <div class="form-group">
                                                 <label for="validationCustom01" class="col-form-label pt-0"><span>*</span> Price: &pound;</label>
                                    ...
                                    <div class="form-group mb-0">
                                        <div class="product-buttons text-center">
                                            <button type="button" class="btn btn-primary" id="addpricebtn">Add Price</button>
...
;
    ...
    $('#addpricebtn').click(function(){
        var formData = new FormData($('#addprices')[0]);
