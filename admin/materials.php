                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="btn-popup pull-right">
                                    <button type="button" class="btn btn-secondary" data-toggle="modal" data-original-title="test" data-target="#exampleModal">Add Material</button>
                                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title f-w-600" id="exampleModalLabel">Add Material</h5>
                                                    ...
                                                    <form id="cat" class="needs-validation" enctype="multipart/form-data">
                                                        <div class="form">
                                                            <div class="form-group">
                                                                <label for="validationCustom01" class="mb-1">Material Name :</label>
                                                                <input class="form-control" name="name" id="name" type="text">
                                                            </div>
                                                            <div class="form-group mb-0">
                                                                <label for="validationCustom02" class="mb-1">Material Image :</label>
                                                                <input class="form-control" name="image" id="image" type="file">
                                                            </div>
                                                        </div>
                                                        <input type="hidden" value="addcategory" name="request">
<!-- </br>
                                        ...
                                        <table class="display" id="basic-1">
                                            ...
                                            <tr>
                                               ...
                                               <td><?php echo $material['status'];?></td>
                                                <td>
                                                    <a href="edit?id=<?php echo $material['material_id']?>" class="icon"><i class="fa fa-pencil"></i></a>
                                                    <a href="delete?id=<?php echo $material['material_id']?>" class="icon"><i class="fa fa-trash"></i></a>
                                            </td>
                                            </tr>
