...
<section class="about-page section-big-py-space">
    <div class="custom-container">
        <div class="row">
            <div class="col-lg-4">
                <div class="banner-section"><img src="assets/images/category/Wooden-Clock.jpg" class="img-fluid   w-100" alt=""></div>
            </div>
            <div class="col-lg-8">
                <h4>Choosen by You, Customized by Us </h4>
                <p class="mb-2"> At The Laser Gift Shop, we specialise in helping you put the personal touch in your chosen gift(s).</p>
                <p class="mb-2"> All our items are made to order and as per your request. We pride ourselves in stocking unique gift items you wouldn’t find in a high street shop. </p>
                <p class="mb-2"> We have hundreds of choices to suit all occasions, be it Weddings, Birthdays, Anniversaries etc. Most of our items are dispatched within 24-48 hours and we have a good choice of delivery options for those last minute gifts.</p>
                <p>Based in the UK and all gifts are posted within 24-48 hours. Secure site to shop with different payment methods available. Hundreds of gifts options to choose from. All gifts personalised and custom made as per your requirements.  We hope you enjoy shopping with The Laser Gift Shop and as always, we are an email away for any questions you may have.</p>
            </div>
        </div>
    </div>
</section>
