...
if(!isset($_SESSION)){
    ...
    $scatproduct = $obj->getsubcatProducts($cate);
    // $bestselling = $obj->getBestSelling();
    // $featured = $obj->getFeatured();
    // $categories = $obj->getCategories();
    $category = $obj->getSubsCategory($cate);
    $subcats = $obj->getSubCategory($category[0]['cat_id']);       
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="row">
            <div class="col">
                <div class="breadcrumb-contain">
                    <div>
                        <h2><?php echo $subcats[0]['category']; ?></h2>
                        <ul>
                            <li><a href="/">home</a></li>
                            <li><i class="fa fa-angle-double-right"></i></li>
                            <li><a href="category?id=<?php echo $category[0]['cat_id'] ?>"><?php echo $subcats[0]['category']; ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        ?>
                            <div class="product-service">
                                <div class="media">
                                    ...
                                    <a  href="subcategory?id=<?php  echo $c['sub_cat_id'] ?>"><h3><?php echo $c['name'] ?></h3></a>
                                    </div>
                                </div>
